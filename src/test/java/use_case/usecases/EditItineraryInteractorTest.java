...
final class EditItineraryInteractorTest {
    ...
    void rejectsNullDependenciesAndInvalidInput() {
        ...
        final InMemoryItineraryDataAccessObject dataAccess = new InMemoryItineraryDataAccessObject();
    ...
    void executeUpdatesExistingItineraryOptionsAndPersistsThem() {
        final InMemoryItineraryDataAccessObject dataAccess = new InMemoryItineraryDataAccessObject();
        final Trip itinerary = new Trip("itin-1", "Toronto", LocalDate.of(2026, 7, 23),
                LocalTime.of(9, 0), LocalTime.of(18, 0), TransportationMode.WALKING);
        final Activity museum = new Activity("museum", "Museum", ActivityCategory.MUSEUM,
        ...
        final EditItineraryInputBoundary interactor = new EditItineraryInteractor(dataAccess);
        final Trip updated = interactor.execute(new EditItineraryInputData(
        ...
        final Trip reloaded = dataAccess.loadItinerary("itin-1").orElseThrow();
    ...
    void executeClipsBoundaryConflictAndRemovesFullyExcludedActivity() {
        final InMemoryItineraryDataAccessObject dataAccess = new InMemoryItineraryDataAccessObject();
        final Trip itinerary = new Trip("itin-2", "Toronto", LocalDate.of(2026, 7, 23),
                LocalTime.of(9, 0), LocalTime.of(18, 0), TransportationMode.WALKING);
        final Activity flexible = new Activity("flexible", "Flexible activity", ActivityCategory.ATTRACTION,
        ...
        final Trip updated = new EditItineraryInteractor(dataAccess).execute(
        ...
        assertEquals(1, updated.getScheduledEvents().size());
        final ScheduledEvent retained = updated.getScheduledEvents().get(0);

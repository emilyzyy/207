...
import trippy.application.autoschedule.PeriodPlan;
import trippy.application.autoschedule.PlacedActivity;
import trippy.application.autoschedule.ScheduleProblem;
import trippy.application.autoschedule.SchedulingPreferences;
import trippy.application.autoschedule.ScheduleScore;
...
import trippy.application.autoschedule.TravelMatrix;
    ...
    void prunedSearchStillMatchesExhaustiveSearchWhenTravelIsNotBeingMinimised() {
        ...
        for (int trial = 0; trial < 60; trial++) {
            ...
            SchedulingPreferences ignoringTravel = new SchedulingPreferences(
                    ...
                    trippy.application.autoschedule.PolicyContext.empty(), false, false);
            ScheduleProblem problem = new ScheduleProblem(availability, items,

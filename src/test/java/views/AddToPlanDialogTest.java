...
final class AddToPlanDialogTest {
    ...
    void constructsAfterTripBoundsAndShowsTheExistingDayPlan() throws Exception {
        ...
        final Activity existing = new MockPlacesService().findAll().get(0);
        final Activity proposed = new MockPlacesService().findAll().get(1);
        final ScheduledEvent planned = new ScheduledEvent(

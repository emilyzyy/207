...
public final class TestRunner {
    public static void main(String[] args) {
        ...
        app.autoSchedule.execute(trip.getId());
        ...
        require(app.distances.estimateTravelMinutes(app.places.findById("rom").get().getLocation(),
                app.places.findById("pai").get().getLocation(), TransportationMode.WALKING)
                > app.distances.estimateTravelMinutes(app.places.findById("rom").get().getLocation(),
                app.places.findById("pai").get().getLocation(), TransportationMode.DRIVING), "transport mode timing");

...
public final class DayPlanShareImageRenderer {
    ...
    public static BufferedImage renderDay(Trip trip, int dayIndex) {
        TripDay day = trip.getDay(dayIndex);
        List<ScheduledEvent> events = day.getScheduledEvents();
        int header = 150;
        ...
        int footer = 52;
        int height = header + body + footer + PAD;
        ...
        try {
            ...
            g.setColor(BLUE);
            String dayLabel = trip.getDayCount() > 1
            ...
            if (events.isEmpty()) {
                ...
                for (ScheduledEvent event : events) {
                    ...
                    String timeRange = event.getStartTime().format(TIME)
                            + " – "
                    ...
                    int maxNameWidth = cardW - 2 * PAD - 20;

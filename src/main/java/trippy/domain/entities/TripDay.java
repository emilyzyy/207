...
public final class TripDay {
    ...
    /**
     * Moves the day boundary while preserving as much of its schedule as possible.
     * Events crossing one edge are clipped; events with both endpoints outside are removed.
     */
    public void updateWindowPreservingSchedule(
        ...
        scheduledEvents.addAll(retained);
        date = newDate;
        startTime = newStart;
        endTime = newEnd;
    }

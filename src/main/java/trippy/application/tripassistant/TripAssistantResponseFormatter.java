...
public final class TripAssistantResponseFormatter {
    ...
    private String activityFact(
        ...
        switch (requestedFact) {
            case SPECIALTY:
                return "Trippy records " + activity.getName() + " as "
            ...
            case RATING:
                return String.format(Locale.ROOT, "%s has a %.1f rating in Trippy.",
            ...
            case LOCATION:
                ...
                return "Trippy lists " + activity.getName() + " at " + address + ".";
            case SETTING:
            ...
            default:
                return "Trippy doesn't include that detail for " + activity.getName()
    ...
    private void appendOpening(StringBuilder answer, TripAssistantRequest request,
        ...
        switch (decision.getIntent()) {
            ...
            case EXPLAIN:
                ...
                break;
            case GENERAL:
                answer.append("Based on the trip information already in Trippy:");
                break;
            default:
    ...
    private void appendActivities(StringBuilder answer, TripAssistantRequest request,
        ...
        answer.append("I used your current Day Plan, trip hours, weather, bookmarks, and "
                ...
                + " travel mode. I only recommend activities currently stored in Trippy.");
    }
